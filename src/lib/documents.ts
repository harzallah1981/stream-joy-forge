...
export const SAMPLE_DOCS: DocItem[] = [
  ...
  mk("cdn", "CDN-TS", "Certificat de Navigabilité — Flotte", "2026", "2026-01-01"),
  mk("ceirb", "CEIRB-26", "Certificat Examen Bruit", "2026", "2026-01-01"),
  ...
  mk("aoc", "AOC-TS-26", "Air Operator Certificate", "Rev 14", "2026-01-01"),
